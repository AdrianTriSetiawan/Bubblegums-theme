...
1. Download the `.vsix` file from the [releases page](https://github.com/AdrianTriSetiawan/Bubblegums-theme/releases)
2. Open VS Code
...
Found a bug or have a suggestion? Please open an issue on [GitHub](https://github.com/AdrianTriSetiawan/Bubblegums-theme/issues).
